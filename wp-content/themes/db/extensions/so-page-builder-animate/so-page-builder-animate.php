...
defined( 'ABSPATH' ) or die( __( 'Make love not war.', 'db' ) );
...
add_filter( 'siteorigin_panels_row_style_groups', 'spba_style_groups', 2, 3 );
add_filter( 'siteorigin_panels_row_style_fields', 'spba_style_fields', 1, 3 );
add_filter( 'siteorigin_panels_row_style_attributes', 'spba_style_attributes', 1, 2 );
...
function spba_libraries() {
	wp_enqueue_style( 'spba-animate', get_template_directory_uri() . '/extensions/so-page-builder-animate/css/animate.min.css', 1.0, true );

	wp_enqueue_script( 'spba-wow', get_template_directory_uri() . '/extensions/so-page-builder-animate/js/wow.min.js', array( 'jquery' ), 1.0, true );
