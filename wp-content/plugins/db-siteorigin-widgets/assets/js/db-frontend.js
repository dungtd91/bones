        ...
        $(function () {
            ...
            var DBOW_Frontend = {
                ...
                carousel: function () {
                    ...
                    var carousel_elements = $('.db-carousel, .db-posts-carousel');
                ...
                setup_parallax: function () {
                    ...
                    function init_parallax() {
                        ...
                        if (DBOW_Frontend.isMobile() === false) {
                            var windowHeight = $(window).height();
                            $('.db-section-bg-parallax').each(function () {
                                var segment = $(this);
                                ...
                                if (boundingRect.bottom >= 0 && boundingRect.top <= windowHeight) {
                                    ...
                                    segment.find('.db-parallax-bg').css('-' + DBOW_Frontend.vendor_prefix() + '-transform', 'translate3d(0px, ' + transformPercent + '%, 0px)');
                                }
                            });
                        }
                ...
                setup_ytp: function () {
                    ...
                    /* Video Backgrounds */
                    $('.db-section-bg-youtube').mb_YTPlayer({
                        startAt: 0,
                        showYTLogo: false,
                        showControls: false,
                        autoPlay: true,
