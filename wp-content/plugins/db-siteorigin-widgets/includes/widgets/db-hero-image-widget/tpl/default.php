...
<div class="db-hero-header db-section-bg-<?php echo $background['bg_type']; ?>" <?php echo $youtube_markup; ?>>

    <div class="db-background">

        <?php if ($background['bg_type'] == 'html5video'): ?>

            <div class="db-html5-video-bg">
    ...
    if (!empty($overlay['overlay_color'])) :
        ...
        <div class="db-overlay" style="<?php echo($bg_color); ?>"></div>
    ...
    <div class="db-header-content">
        ...
        <?php if ($header_type == 'standard') : ?>
            ...
            <div class="db-standard-header">

                <?php echo empty($standard_header['subheading']) ? '' : '<div class="db-subheading">' . htmlspecialchars_decode($standard_header['subheading']) . '</div>'; ?>

                <?php echo empty($standard_header['heading']) ? '' : '<h3 class="db-heading">' . $standard_header['heading'] . '</h3>'; ?>
    ...
    <?php if (!empty($pointer_down_url)): ?>
        ...
        <a href="<?php echo $pointer_down_url; ?>" class="icon-angle-down db-pointer-down"></a>
